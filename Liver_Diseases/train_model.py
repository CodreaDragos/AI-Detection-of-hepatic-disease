...
# Save the model (fixing the serialization issue)
try:
    model.save('evaluation_results/trained_model_resnet50.h5', save_format='h5')
except Exception as e:
    print(f"Warning: Could not save model in h5 format: {e}")
    try:
        model.save('evaluation_results/trained_model_resnet50', save_format='tf')
        print("Model saved in TensorFlow format instead")
    except Exception as e:
...
# Save training history as numpy array
np.save('evaluation_results/training_history.npy', history)
